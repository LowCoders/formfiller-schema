 ...
 */
export function validateField(fieldConfig: interfaces.FieldConfig): {
  valid: boolean;
  errors: any[];
} {
 ...
 * @returns Validation result with errors if any
 */
export function validateItem(itemConfig: interfaces.ItemConfig): { valid: boolean; errors: any[] } {
 ...
 * @returns Validation result with errors if any
 */
export function validateView(viewConfig: interfaces.ItemConfig): { valid: boolean; errors: any[] } {
